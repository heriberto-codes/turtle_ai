...
- If security review depends on framework, auth provider, middleware, or SDK behavior, use Context7 to consult current official documentation before making assumptions.
